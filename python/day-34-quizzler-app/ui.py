...
class QuizInterface:
    ...
    def __init__(self, quiz_brain:QuizBrain): # 'quizbrain:Quizbrain' ensures we pass
        # the correct datatype when we initialise QuizInterface (I still don't get it,
        # watch video 263 again)
        ...
        self.tick = Button(image=tick_img, highlightthickness=0,
                           command=self.tick_pressed)
        self.cross = Button(image=cross_img, highlightthickness=0,
                            command=self.cross_pressed)
